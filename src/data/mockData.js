...
export const DICTIONARY = {
  en: {
    ...
    heroDesc: "Have a peaceful morning. We have prepared your gentle memory exercises and family voice notes for today.",
    recommendedActivity: "Recommended Activity",
    viewTimeline: "View All Timeline →",
    importantMedicine: "Important Medicine",
  ...
  as: {
    ...
    heroDesc: "শুভ ৰাতিপুৱা। আজিৰ বাবে আপোনাৰ স্মৃতি অনুশীলন আৰু পৰিয়ালৰ মাত প্ৰস্তুত কৰা হৈছে।",
    recommendedActivity: "প্ৰস্তাৱিত কাৰ্যসূচী",
    viewTimeline: "সকলো সময়সূচী চাওক →",
    importantMedicine: "জৰুৰী ঔষধ",
    dailyRoutine: "দৈনন্দিন নিয়ম",
